...
public class Start {
    ...
    public static void loginManager() throws Exception{
        ...
        if(username.equalsIgnoreCase("admin") & password.equals("admin@123")){
            String num;
            do {
                System.out.println("Enter 1 to display console");
                System.out.println("Enter 2 to display GUI");
    ...
    public static void displayMenu() throws Exception{
        ...
        System.out.println("Sort members       -   4");
        System.out.println("Save member list   -   5");
        ...
        switch (num){
            ...
            case 3: //viewAll();
                break;
           // case 4: new MyGymManager().saveVehicleList();
           //     break;
            case 5:
        ...
        switch (ans){
            case "1":
                try {
                    ...
                    //Date date=(Date)scanner.nextLine();
                }catch (InputMismatchException e){
                    System.err.println("Wrong input");
                    addDetails();
                }
    ...
    public static void deleteDetails()throws Exception{
        ...
        switch (ans){
            case "1" :
                ...
                //new WestminsterRentalVehicleManager().deleteCar(delete);
                System.out.println();
                displayMenu();
                break;
            ...
            case "2" :
                ...
                //new WestminsterRentalVehicleManager().deleteBike(delete);
                System.out.println();
                displayMenu();
                break;
